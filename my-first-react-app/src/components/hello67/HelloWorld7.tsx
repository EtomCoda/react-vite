...
fetch(`https://jsonplaceholder.typicode.com/users/${userIdInput.current!.value}`);
...
setUserFetched({user: null, error: error.message});
    ...
    useEffect(() => {
        ...
        <p>
        <button className='bg-red-500 hover:bg-blue-700 text-white py-2 px-4 
        rounded' onClick={fetchData}>
        Fetch User
        </button>
        </p>
        <p>
